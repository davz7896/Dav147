...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2019 at 08:15 PM
...
INSERT INTO `kavling` (`nim1`, `kode_perumahan`, `blok`, `no_kav`, `l_tanah`, `l_bangunan`, `tipe`, `posisi`, `harga`, `ppn`, `total`, `pelunasan`, `utj`, `dp`, `status`) VALUES
('FR/A/001', 'FR', 'A', '001', '150', '150', 'Upnormal', 'Lurus', 100000000, 10000000, 110000000, 0, 0, 1000000, ''),
('FR/A/002', 'FR', 'A', '002', '150', '150', 'Upnormal', 'Lurus', 5000000, 500000, 5500000, 0, 0, 5000000, ''),
('FR/A/003', 'FR', 'A', '003', '150', '150', 'Upnormal', 'Lurus', 7000000, 700000, 7700000, 0, 0, 7000000, ''),
('FR/A/004', 'FR', 'A', '004', '150', '150', 'Upnormal', 'Lurus', 10000000, 1000000, 11000000, 0, 0, 1000000, ''),
('MR/A/001', 'MR', 'A', '001', '150', '150', 'Upnormal', 'Lurus', 1000000, 100000, 1100000, 0, 0, 0, ''),
('MR/A/002', 'MR', 'A', '002', '150', '150', 'Upnormal', 'Lurus', 1000000, 100000, 1100000, 0, 0, 0, ''),
('MR/A/003', 'MR', 'A', '003', '150', '150', 'Upnormal', 'Lurus', 70000000, 7000000, 77000000, 0, 0, 0, '');
...
CREATE TABLE `penjualan` (
  ...
  `tgl_angsur_akhir` varchar(30) NOT NULL,
  `harga_jadi` varchar(30) NOT NULL,
  `tgl_mulaiterjual` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `penjualan` (`kode_transaksi`, `id_pelanggan`, `id_kavling`, `no_kavling`, `tgl_jual`, `utj`, `dp`, `angsuran`, `x_angsur`, `tgl_angsur_awal`, `tgl_angsur_akhir`, `harga_jadi`, `tgl_mulaiterjual`) VALUES
('FR/A/0030033', '7136163', 'FR/A/003', '003', '17-05-2019', 'Rp. 1.000.000', 'Rp.1.340.000', 'Rp.1.786.667', '3', '2019-05-17', '2019-07-17', 'Rp.7.700.000', '0000-00-00'),
('FR/A/0040043', 'P001', 'FR/A/004', '004', '17-05-2019', 'Rp. 1.000.000', 'Rp.2.000.000', 'Rp.2.666.667', '3', '2019-05-17', '2019-07-17', 'Rp.11.000.000', '0000-00-00');
